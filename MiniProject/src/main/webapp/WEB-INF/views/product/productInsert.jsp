		...
		<div class="innerOuter">
			...
			<form id="enrollForm" method="post" action="productInsert.ui">
				...
				<div class="form-group">
                    ...
                    <input type="text" class="form-control" id="productType" placeholder="상품 유형을 입력하세요(ex 고양이,강아지 등...)" name="productType" required> <br>
                    
                    <label for="productCount">* 상품개수 : </label>
                    <input type="text" class="form-control" id="productCount" placeholder="개수를 입력하세요(숫자만)" name="productCount" required> <br>

                    
					
                    <label for="productPrice">* 상품 가격 : </label>
                    <input type="text" class="form-control" id="productPrice" placeholder="숫자만 입력하세요(숫자만)" name="productPrice" required> <br>
                    
                    <label for="productContent">* 내용 : </label>
                    <textarea class="form-control" rows="30" id="productContent" placeholder="내용을 입력하세요" name="productContent" required></textarea> <br>
